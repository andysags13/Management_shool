                                    ...
                                    <div class="list-icons">
                                        <div class="dropdown">
                                            ...
                                            <div class="dropdown-menu dropdown-menu-left">
                                                ...
                                                {{--Delete--}}
                                                <a id="{{ $c->id }}" onclick="confirmDelete(this.id)" href="#" class="dropdown-item"><i class="icon-trash"></i> {{ __('msg.delete') }}</a>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="alert alert-info border-0 alert-dismissible">
                                ...
                                <span>{{ __('msg.class_creation_info') }} <a target="_blank" href="{{ route('sections.index') }}">{{ __('msg.manage_sections') }}</a></span>
                            </div>
                        </div>
                    </div>
