<div class="tab-pane fade" id="edit-subs">
    ...
    @if($tts->count())
                    ...
                    <div class="col-md-6">
                        <div class="card">
                            <div class="card-header header-elements-inline">
                                <h6 class="card-title font-weight-bold">{{ ($tt->exam_date ? __('msg.exam_date', ['date' => date('D\, d/m/Y', strtotime($tt->exam_date))]) : $tt->day) }} {{ '('.$tt->time_slot->full.')' .' - '.$tt->subject->name }}</h6>
                                    ...
                                    <form  method="post" action="{{ route('tt.update', $tt->id) }}">
                                        ...
                                        @if($ttr->exam_id)
                                            ...
                                            <div class="form-group row">
                                                <label class="col-lg-3 col-form-label font-weight-semibold">{{ __('msg.exam_date') }} <span class="text-danger">*</span></label>
                                                <div class="col-lg-9">
                                        ...
                                        @else
                                            ...
                                            <div class="form-group row">
                                                <label for="day"
                                                       class="col-lg-3 col-form-label font-weight-semibold">{{ __('msg.day') }}
                                        ...
                                        <div class="form-group row">
                                            <label for="subject_id"
                                                   class="col-lg-3 col-form-label font-weight-semibold">{{ __('msg.subject') }}
                                                <span class="text-danger">*</span></label>
                                            <div class="col-lg-9">
                                        ...
                                        <div class="text-right">
                                            <button type="submit" class="btn btn-primary">{{ __('msg.submit_form') }} <i class="icon-paperplane ml-2"></i>
                                            </button>
                                        </div>
                                    </form>
                                </div>
        ...
        @endforeach
    @else
        <div class="alert alert-info text-center">{{ __('msg.no_records') }}</div>
    @endif
</div>