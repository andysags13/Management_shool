                    ...
                    <div class="tab-pane fade" id="ttr{{ $mc->id }}">                         <table class="table datatable-button-html5-columns">
                            ...
                            @foreach($tt_records->where('my_class_id', $mc->id) as $ttr)
                                <tr>
                                    ...
                                    <td>{{ ($ttr->exam_id) ? $ttr->exam->name : __('msg.class_timetable') }}
                                    <td>{{ $ttr->year }}</td>
                                            ...
                                            <div class="dropdown">
                                                ...
                                                <div class="dropdown-menu dropdown-menu-right">
                                                    ...
                                                    @if(Qs::userIsSuperAdmin())
                                                        <a id="{{ $ttr->id }}" onclick="confirmDelete(this.id)" href="#" class="dropdown-item"><i class="icon-trash"></i> {{ __('msg.delete') }}</a>
